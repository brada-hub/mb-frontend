...
const getEstadoClasses = (estado) => {
    ...
    switch (normalized) {
        ...
        case 'JUSTIFICADO':
            return 'bg-[#ffbe0b]/20 text-[#ffbe0b] border-[#ffbe0b]/30';
        default:
        ...
        >
            ...
            <motion.div
                ...
                className={clsx(
                    ...
                    isLongPressing ? "bg-[#ffbe0b]/20 scale-[0.98] shadow-inner" : "bg-surface-card hover:bg-black/[0.02] dark:hover:bg-white/[0.02]",
                    estadoActual === 'PRESENTE' && !isLongPressing && "bg-green-500/[0.04]",
                    estadoActual === 'FALTA' && !isLongPressing && "bg-red-500/[0.04]",
                    estadoActual === 'JUSTIFICADO' && !isLongPressing && "bg-[#ffbe0b]/[0.04]"
                )}
            >
                <div>
                    <div className="flex items-center justify-between gap-3">
                                ...
                                <div className="flex flex-col">
                                    <p className="text-[9px] text-gray-500 font-bold uppercase tracking-wider leading-tight flex items-center gap-2">
                                        ...
                                        {conv.asistencia?.latitud_marcado && (
                                            <span className="flex items-center gap-1 text-[#bc1b1b] dark:text-[#bc1b1b] bg-[#bc1b1b]/10 px-1.5 py-0.5 rounded-md text-[7px] font-black border border-[#bc1b1b]/20 transition-colors">
                        ...
                        {(isAdmin || isDirector) && (
                            <button 
                                ...
                                className="p-1.5 sm:p-2 bg-black/5 dark:bg-white/5 hover:bg-[#bc1b1b]/10 text-gray-500 hover:text-[#bc1b1b] rounded-lg sm:rounded-xl transition-all border border-gray-200 dark:border-white/5 hover:border-[#bc1b1b]/20 group/rep"
        ...
        <div className="space-y-4 sm:space-y-8 animate-in fade-in duration-500">
            <div className="flex items-center justify-between pb-1 sm:pb-2">
                ...
                {(isAdmin || isDirector) && (
                    ...
                    >
                        <FileText className="w-3.5 h-3.5 text-[#bc1b1b]" />
                        Reporte
                    </button>
                )}
            </div>
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={`w-full text-left p-3 sm:p-4 rounded-xl border transition-all cursor-pointer ${
                                            isSelected 
                                                ? 'bg-[#bc1b1b]/10 border-[#bc1b1b]/40 shadow-lg shadow-[#bc1b1b]/5' 
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-2">
                                            <span className={`px-1.5 py-0.5 rounded-md text-[8px] font-black uppercase tracking-wider ${
                                                evento.tipo?.evento === 'ENSAYO' ? 'bg-[#bc1b1b]/20 text-[#bc1b1b]' :
                                        ...
                                        <div className="flex items-center justify-between text-[10px] text-gray-500 font-bold uppercase tracking-widest">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <ChevronRight className={`w-4 h-4 transition-transform ${isSelected ? 'rotate-90 text-[#bc1b1b]' : 'text-gray-700'}`} />
                                            </div>
                                        </div>
                                    </motion.div>
                                );
                            ...
                            <div className="sticky top-0 z-40 bg-white dark:bg-[#1e2335] border-b border-surface-border p-3 sm:p-6 shadow-lg transition-colors">
                                <div className="flex items-center justify-between mb-3 xl:hidden">
                                    <div className="flex items-center gap-2">
                                        <button 
                                            ...
                                            className="text-[#bc1b1b] hover:text-white transition-colors"
                                        >
                                            <ArrowLeftCircle className="w-7 h-7" />
                                        </button>
                                        <div className="bg-[#bc1b1b]/10 px-2 py-0.5 rounded-full border border-[#bc1b1b]/20">
                                            <span className="text-[8px] font-black text-[#bc1b1b] uppercase tracking-widest">CONTROL</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3 overflow-x-auto no-scrollbar py-1">
                                        <div className="flex items-center gap-1 text-[8px] font-black text-[#bc1b1b]/60 uppercase whitespace-nowrap">
                                    ...
                                    <div className="flex gap-2 relative">
                                        <div className="relative">
                                            {hasFullAccess ? (
                                                    ...
                                                    <button 
                                                        ...
                                                        className={clsx(
                                                            ...
                                                            selectedInstrumento !== 'TODOS' 
                                                                ? "bg-[#bc1b1b] border-[#bc1b1b] text-white" 
                                                                ...
                                                                {instrumentos.map(inst => (
                                                                    <button 
                                                                        ...
                                                                        className={clsx(
                                                                            ...
                                                                            selectedInstrumento === inst.id_instrumento.toString() ? "bg-[#bc1b1b] text-white" : "text-gray-500 hover:bg-white/5"
                                                                        )}
                                                                    >
                                                                        {inst.instrumento}
                                                                    </button>
                                                ...
                                                <div className="h-10 px-4 bg-[#bc1b1b]/10 border border-[#bc1b1b]/20 rounded-xl flex items-center gap-2 text-[9px] font-black text-[#bc1b1b] uppercase tracking-widest">
                                        ...
                                        {puedeMarcar && (
                                            <div className="relative">
                                                <button 
                                                    ...
                                                    className="h-10 w-10 sm:w-auto sm:px-4 rounded-xl bg-[#bc1b1b]/10 border border-[#bc1b1b]/20 text-[#bc1b1b] flex items-center justify-center gap-2 hover:bg-[#bc1b1b] hover:text-white transition-all text-xs"
                                                >
                                                ...
                                                <AnimatePresence>
                                                    {isActionsOpen && (
                                                        <motion.div 
                                                            ...
                                                            animate={{ opacity: 1, scale: 1, y: 0 }}
                                                            exit={{ opacity: 0, scale: 0.95, y: 10 }}
                                                            className="absolute right-0 top-full mt-2 w-56 bg-[#bc1b1b] border border-white/10 rounded-2xl shadow-2xl z-50 p-2 overflow-hidden"
                                                        >
                                                            <button 
                                ...
                                {(hasFullAccess || isJefe) && (
                                    <div className="mt-3 relative">
                                        <input 
                                            ...
                                            className="w-full bg-black/20 border border-white/10 rounded-xl py-2 pl-9 pr-4 text-xs font-bold text-white placeholder-gray-600 focus:outline-none focus:border-[#bc1b1b]/50 transition-colors uppercase tracking-wide"
                                        />
                                    ...
                                    {(hasFullAccess || isJefe) && (
                                        <div className="flex bg-white/5 p-1 rounded-xl mt-3">
                                            ...
                                            >
                                                ...
                                                {stats.sinMarcar > 0 && (
                                                    <span className="w-4 h-4 sm:w-5 sm:h-5 bg-[#bc1b1b] text-white rounded-full flex items-center justify-center text-[8px] sm:text-[10px] animate-pulse">
                                                        {stats.sinMarcar}
                                                    </span>
                                                )}
                                            </button>
                                ...
                                {(hasFullAccess || isJefe) && (
                                    <div className="grid grid-cols-5 gap-1.5 sm:gap-3 mt-3 sm:mt-5">
                                        ...
                                        <div className="bg-[#bc1b1b]/10 border border-[#bc1b1b]/20 rounded-xl px-2 py-1.5 sm:p-3 flex flex-col items-center justify-center transition-all">
                                            <p className="text-sm sm:text-xl font-black text-[#bc1b1b] leading-tight">{stats.permisos}</p>
                                            <p className="text-[7px] sm:text-[9px] font-black text-[#ffbe0b] uppercase tracking-tighter sm:tracking-widest mt-0.5">Perm.</p>
                                        </div>
                                        ...
                                        {(() => {
                                            ...
                                            return (
                                                <button 
                                                    ...
                                                    className="w-full py-6 bg-gradient-to-r from-[#bc1b1b] to-[#7f1d1d] hover:from-[#a31515] hover:to-[#601414] text-white rounded-[2rem] shadow-2xl shadow-[#bc1b1b]/30 flex flex-col items-center gap-1 group transition-all active:scale-95 disabled:opacity-50 border border-white/10"
                                                >
                                                    {saving ? (
                                        ...
                                        <div className="divide-y divide-white/5">
                                            ...
                                            {activeTab === 'PENDIENTES' && listaAsistencia.filter(c => asistenciasTemp[c.id_convocatoria] === null && (selectedInstrumento === 'TODOS' || c.miembro?.instrumento?.id_instrumento === parseInt(selectedInstrumento))).length === 0 && (
                                                ...
                                                >
                                                    ...
                                                    <Button 
                                                        onClick={() => setSelectedEvento(null)}
                                                        className="mt-8 xl:hidden h-12 px-8 rounded-2xl bg-[#bc1b1b] hover:bg-[#bc1b1b] text-white font-black uppercase tracking-widest text-xs"
                                                    >
                                                        Volver al Menú
                                                    </Button>
                                                </motion.div>
                                ...
                                <div className="p-12 text-center bg-gray-50 dark:bg-black/20">
                                    <div className="max-w-xs mx-auto space-y-8">
                                        <div className="space-y-2">
                                            <div className="w-16 h-16 bg-[#bc1b1b]/10 rounded-3xl flex items-center justify-center mx-auto text-[#bc1b1b] mb-4">
                ...
                <AnimatePresence>
                    {showPermisoModal && (
                        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                            ...
                            >
                                <div className="p-8">
                                    <div className="w-16 h-16 bg-[#bc1b1b]/10 text-[#ffbe0b] rounded-3xl flex items-center justify-center mb-6">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <button 
                                            ...
                                            className="flex-1 py-3 bg-[#bc1b1b] hover:bg-[#bc1b1b]/50 text-white font-black uppercase tracking-widest text-[10px] rounded-2xl shadow-lg shadow-[#bc1b1b]/20 transition-all"
                                        >
                                            Guardar
                                        </button>
                                    </div>
                            ...
                            >
                                <div className="p-6 border-b border-white/5">
                                    <div className="flex items-center gap-4 mb-6">
                                        <div className="w-12 h-12 bg-[#bc1b1b]/10 text-[#bc1b1b] rounded-2xl flex items-center justify-center">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className="w-full bg-black/20 border border-white/5 rounded-2xl py-3 pl-12 pr-4 text-white text-xs focus:outline-none focus:border-[#bc1b1b]/50 transition-all font-bold"
                                        />
                                    </div>
                                </div>
                                    ...
                                    {loadingReemplazo ? (
                                        ...
                                        miembrosDisponibles.filter(m => 
                                            ...
                                            <button
                                                ...
                                                className="w-full flex items-center justify-between p-3 rounded-2xl bg-white/[0.02] hover:bg-[#bc1b1b] border border-white/5 hover:border-[#bc1b1b]/30 transition-all group"
                                            >
                                                <div className="flex items-center gap-3">
                ...
                <AnimatePresence>
                    {snackbar.show && (
                        <motion.div 
                            ...
                            className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] w-[calc(100%-48px)] max-w-md bg-[#bc1b1b] rounded-3xl p-4 shadow-2xl flex items-center justify-between border border-white/20 backdrop-blur-xl"
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-black text-white/80 uppercase tracking-widest">Sincronizando...</span>
                                    <span className="text-sm font-bold text-white">{snackbar.message}</span>
                                </div>
                            </div>
                            <button 
                                onClick={handleUndo}
                                className="px-4 py-2 bg-white text-[#bc1b1b] text-xs font-black uppercase tracking-widest rounded-xl hover:bg-gray-100 transition-colors"
                            >
                                Deshacer
                            </button>
                        </motion.div>

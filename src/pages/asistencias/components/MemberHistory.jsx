...
export default function MemberHistory({ memberId }) {
    ...
    if (loading) return (
        <div className="p-8 flex justify-center">
            <div className="w-6 h-6 border-2 border-white/20 border-t-[#bc1b1b] rounded-full animate-spin"></div>
        </div>
    );
    ...
    return (
        <div className="p-5 bg-[#000000] rounded-2xl mt-3 border border-[#bc1b1b]/10 space-y-5 shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#bc1b1b]/5 blur-3xl rounded-full -mr-16 -mt-16" />
                        ...
                        <div className="w-12 h-1 bg-white/10 rounded-full mt-1 overflow-hidden">
                            <motion.div 
                                ...
                                className={clsx(
                                    ...
                                    data.stats?.attendance_rate >= 50 ? "bg-[#ffbe0b]" : "bg-[#bc1b1b]"
                                )}
                            />
                        </div>
                    </div>
            ...
            <div className="space-y-3 relative z-10">
                <div className="flex items-center justify-between px-1">
                    ...
                    <Activity className="w-3 h-3 text-[#bc1b1b]/50" />
                </div>
                    ...
                    {data.history.map((event, idx) => (
                        ...
                        >
                            <div className="min-w-0 flex-1">
                                <p className="text-xs font-bold text-white group-hover:text-[#bc1b1b] transition-colors truncate">{event.evento}</p>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                {event.estado === 'RETRASO' && <span className="text-[8px] bg-[#ffbe0b]/20 text-[#ffbe0b] border border-[#ffbe0b]/30 px-2 py-1 rounded-lg font-black uppercase tracking-tighter">Retraso</span>}
                                {event.estado === 'FALTA' && <span className="text-[8px] bg-[#bc1b1b]/20 text-[#bc1b1b] border border-[#bc1b1b]/30 px-2 py-1 rounded-lg font-black uppercase tracking-tighter">Falta</span>}
                                {event.estado === 'JUSTIFICADO' && <span className="text-[8px] bg-[#ffbe0b]/20 text-[#ffbe0b] border border-[#ffbe0b]/30 px-2 py-1 rounded-lg font-black uppercase tracking-tighter">Permiso</span>}
            ...
            <div className="relative z-10">
                <motion.button 
                    ...
                    className="w-full py-3.5 bg-green-500 hover:bg-green-400 text-[#000000] rounded-2xl text-xs font-black uppercase tracking-widest flex items-center justify-center gap-3 shadow-xl shadow-green-500/20 transition-all border-b-4 border-green-700 active:border-b-0 active:translate-y-1"
                >
